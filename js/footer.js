...
document.addEventListener("DOMContentLoaded", function () {
	...
	line2.textContent = "USDT:TMDA2iaMqbk5GhVfa5F5dUFCYe7N8xRVtN";
	...
	// 创建第三行页脚元素并设置文本内容、字体大小和颜色
	var line3 = document.createElement("div");
	line3.textContent = "	该地址仅支持trx/trc20相关资产";
	line3.style.fontSize = "0.9125rem"; // 设置初始的第二行页脚的字体大小
	line3.style.color = "red"; // 设置第二行页脚的字体颜色
	line3.style.cursor = "pointer"; // 设置鼠标样式为指针
